...
<body>
    <div class="contenedor">
        ...
        <div class="contenido">
                <?php 
                    $query = mysqli_query($conexion, "SELECT p.id_product, p.name_product, p.quantity, p.price, t.descrip_product, p.imagen FROM PRODUCTS p inner join TYPE_PRODUCTS t ON p.fk_id_type_product = t.id_type_product WHERE p.state=1 AND p.fk_id_type_product=".$_GET['id']);
                ...
                <div class="contenido2">
                    <div class="boxImagen">
                        <span><img style="width:30%" src="data:image/png;base64,<?php echo base64_encode($row['imagen']); ?>"/></span>
                    </div>
                    <div class = "boxTexto">
                        <span class=""><h3>Articulo: <?php echo $row["name_product"];?></h3></span><br>
                        <span class=""><p>Precio: <?php echo $row["price"];?></p></span>
                        <span class=""><a href="detalleProducto.php?id=<?php echo $row["id_product"];?>">Ver más</a></span>
                    </div> 
                </div>
                    <?php
                        }
