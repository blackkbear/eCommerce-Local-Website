...
if(isset($_POST['submit'])){
    ...
    values('$name_user', '$surnames_user', '$phone_user', '$state_user', '$email_user', '$password_user', '$fk_id_type_user')";
...
<head>
    ...
    <title>Agregar Usuarios - Kento</title>
    ...
    <div class="Content tablas my-5">
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Ingresa el estado del usuario:" name="state_user"
                    autocomplete="off">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Ingrese el tipo de Usuario:" name="fk_id_type_user"
                    autocomplete="off">
            </div>
